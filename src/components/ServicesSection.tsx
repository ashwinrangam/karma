...
export const ServicesSection = () => {
  ...
  return (
    <section className="relative min-h-screen py-24 px-4 md:px-12">
      {/* Custom Animated Background */}
      <ThreeBackground type="matrix" className="z-0" enabled={true} />
      {/* Animated Gradient Overlay */}
      <div className="absolute inset-0 z-10 pointer-events-none" style={{
        background: 'linear-gradient(120deg, rgba(26,26,26,0.95) 60%, rgba(0,240,255,0.08) 100%)',
        mixBlendMode: 'screen',
